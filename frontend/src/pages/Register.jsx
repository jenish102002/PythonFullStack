...
export default function Register() {
    ...
    return (
        <div style={{
            ...
            padding: '1rem',
            backgroundImage: 'url(/assets/images/cricket_action_shot.png)',
            ...
            <div className="glass-panel animate-fade-in" style={{ width: '100%', maxWidth: '420px', padding: '3rem 2.5rem', position: 'relative', zIndex: 10 }}>
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    ...
                    <p style={{ color: 'var(--text-secondary)' }}>Join the league today.</p>
                </div>
                ...
                <div style={{ textAlign: 'center', marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid var(--border-glass)' }}>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
                        Already a player? <Link to="/login" style={{ color: 'var(--primary)', fontWeight: '600' }}>Log in</Link>
                    </p>
                </div>
            </div>
        </div>
